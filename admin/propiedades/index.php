        ...
        <table class="excel" border="1">
          ...
          while ($f =$res->fetch_assoc()) {?>
            <tr>
              ...
              <td class="borrar"><a href="imagenes.php?id=<?php echo $f['propiedad']?>" class="btn-floating pink"><i
                class="material-icons">image</i></a></td>
              <td class="borrar"><a href="mapa.php?mapa=<?php echo $f['mapa']?>" target="_blank" class="btn-floating orange"><i
                class="material-icons">room</i></a></td>
              <td class="borrar"><a href="pdf.php?id=<?php echo $f['propiedad']?>" target="_blank" class="btn-floating green"><i
                class="material-icons">picture_as_pdf</i></a></td>
              <td class="borrar"><a href="editar_propiedad.php?id=<?php echo $f['propiedad']?>" target="_blank" class="btn-floating blue"><i
              ...
              }).then((result) => { if (result.value){location.href='cancelar_propiedad.php?id=<?php echo $f['propiedad']?>&accion=CANCELADO';}})"><i class="material-icons">delete</i></a></td>
